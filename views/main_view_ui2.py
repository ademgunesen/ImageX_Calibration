...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabwidget.setGeometry(QtCore.QRect(0, 0, 1271, 581))
        ...
        self.groupBox.setGeometry(QtCore.QRect(0, 0, 1251, 491))
        ...
        self.player.setGeometry(QtCore.QRect(0, 40, 1201, 401))
        ...
        self.player.setText("")
        self.player.setScaledContents(False)
        ...
        self.dot_pixel_3.setGeometry(QtCore.QRect(510, 450, 16, 16))
        ...
        self.dot_pixel_2.setGeometry(QtCore.QRect(500, 450, 16, 16))
        palette = QtGui.QPalette()
        ...
        self.dot_pixel_1.setGeometry(QtCore.QRect(490, 450, 16, 16))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.progressBar.setGeometry(QtCore.QRect(180, 450, 251, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.progressing.setGeometry(QtCore.QRect(70, 450, 101, 31))
        font = QtGui.QFont()
        ...
        self.gif = QtWidgets.QLabel(self.groupBox)
        self.gif.setGeometry(QtCore.QRect(20, 450, 31, 31))
        self.gif.setAutoFillBackground(True)
        self.gif.setText("")
        self.gif.setScaledContents(True)
        self.gif.setObjectName("gif")
        self.layoutWidget = QtWidgets.QWidget(self.tab_1)
        self.layoutWidget.setGeometry(QtCore.QRect(380, 500, 371, 41))
        self.layoutWidget.setObjectName("layoutWidget")
        self.gridLayout = QtWidgets.QGridLayout(self.layoutWidget)
        self.gridLayout.setContentsMargins(0, 0, 0, 0)
        self.gridLayout.setObjectName("gridLayout")
        self.select_pixel_1 = QtWidgets.QPushButton(self.layoutWidget)
        self.select_pixel_1.setObjectName("select_pixel_1")
        self.gridLayout.addWidget(self.select_pixel_1, 0, 0, 1, 1)
        self.select_pixel_2 = QtWidgets.QPushButton(self.layoutWidget)
        self.select_pixel_2.setObjectName("select_pixel_2")
        self.gridLayout.addWidget(self.select_pixel_2, 0, 1, 1, 1)
        self.select_pixel_3 = QtWidgets.QPushButton(self.layoutWidget)
        self.select_pixel_3.setObjectName("select_pixel_3")
        self.gridLayout.addWidget(self.select_pixel_3, 0, 2, 1, 1)
        self.layoutWidget1 = QtWidgets.QWidget(self.tab_1)
        self.layoutWidget1.setGeometry(QtCore.QRect(10, 500, 351, 43))
        self.layoutWidget1.setObjectName("layoutWidget1")
        self.gridLayout_6 = QtWidgets.QGridLayout(self.layoutWidget1)
        self.gridLayout_6.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_6.setObjectName("gridLayout_6")
        self.select_video = QtWidgets.QPushButton(self.layoutWidget1)
        self.select_video.setObjectName("select_video")
        self.gridLayout_6.addWidget(self.select_video, 0, 0, 1, 1)
        self.run_video = QtWidgets.QPushButton(self.layoutWidget1)
        ...
        self.stop_video = QtWidgets.QPushButton(self.layoutWidget1)
        ...
        self.ErrorGroupBox.setGeometry(QtCore.QRect(790, 10, 391, 221))
        font = QtGui.QFont()
        ...
        self.groupBox_1.setGeometry(QtCore.QRect(10, 10, 191, 191))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(10, 200, 191, 191))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.groupBox_4.setGeometry(QtCore.QRect(220, 20, 231, 231))
        font = QtGui.QFont()
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(220, 260, 231, 231))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.groupBox_6.setGeometry(QtCore.QRect(470, 170, 301, 171))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.T2_label_5.setGeometry(QtCore.QRect(210, 30, 71, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.T2_label_7.setGeometry(QtCore.QRect(210, 90, 71, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.T2_label_6.setGeometry(QtCore.QRect(210, 60, 71, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.T2_label_8.setGeometry(QtCore.QRect(210, 120, 71, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.groupBox_5.setGeometry(QtCore.QRect(470, 10, 301, 151))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.T1_label_5.setGeometry(QtCore.QRect(210, 30, 71, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.T1_label_7.setGeometry(QtCore.QRect(210, 90, 71, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.T1_label_6.setGeometry(QtCore.QRect(210, 60, 71, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.T1_label_8.setGeometry(QtCore.QRect(210, 120, 71, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.clear.setGeometry(QtCore.QRect(470, 350, 101, 31))
